...
export function WeddingStory() {
  ...
  const storyBlocks = [
    ...
    },
    {
      ...
      text: '15 ноября 2025 состоится церемония бракосочетания. И мы будем рады, если вы будете рядом в этот день!',
      imagePosition: 'right' as const
    }
  ];
      ...
      <div className="container mx-auto px-4">
        {storyBlocks.map((block, index) => (
          <div
            ...
            className={`mb-8 md:mb-16 lg:mb-24 transition-all duration-500 ease-out ${
              visibleBlocks[index] 
          ...
          >
            <div className={`flex flex-col ${block.imagePosition === 'right' ? 'md:flex-row' : 'md:flex-row-reverse'} items-center gap-8 md:gap-16 min-h-[300px] md:min-h-[400px]`}>
              ...
              <div 
                ...
                className={`flex-1 text-center transition-all duration-500 ease-out delay-100 px-4 md:px-0 ${
              ...
              <div 
                ...
                className={`flex-1 max-w-lg transition-all duration-500 ease-out delay-200 ${
